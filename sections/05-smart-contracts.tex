...
When a project first registers, \handler{receiveReward} returns the empty
...
% TODO: Isn't the money already in the project fund?
...
% TODO: who are memebers here? maintainers? can we use that terminology instead?
...
with the \handler{updateContract} handler. The
...
% TODO: 'keys which signed votes for the contract update transaction' this phrase isn't
...
and \handler{receiveTransfer} handlers, it will also be necessary to occasionally
...
% TODO: who are the votes from? one per maintainer?
