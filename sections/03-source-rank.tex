...
\begin{center}
\begin{tikzpicture}[vertex/.style={draw,circle}, arr/.style={draw,thick,-latex}]
...
\end{tikzpicture}
\captionof{figure}{Network Graph $G$}
\label{fig:G}
\end{center}
...
The main reason the weights of $\contrib$ and $\cocontrib$ are so low in
comparison to the other weights is because these relationships are much more
numerous in $\netgraph$.
