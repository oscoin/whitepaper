...
the account associated with $k_1$. This helps ensures that abandoned projects
...
Because all changes to a project's source code are signaled by checkpoints, it
